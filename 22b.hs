...
f xs = sum $ map getSize $ f' [] xs
  where
    ...
    f' ss (q:qs) = f' ss' qs
      where
        ss' = combine $ filter t1 $ q:concatMap (splitup q) ss
        fincr = filter incr
        incr = uncurry (<=)
        ...
        combine ((b, (x1, y1, z1), (x2, y2, z2)):(b', (x1', y1', z1'), (x2', y2', z2')):xs)
          | b' == b && x1' == x1 && x2' == x2 && y1' == y1 && y2' == y2 && z2' + 1 == z1  =
            combine $ (b, (x1, y1, z1'), (x2, y2, z2 )):xs
          | b' == b && x1' == x1 && x2' == x2 && y1' == y1 && y2' == y2 && z2  + 1 == z1' =
            combine $ (b, (x1, y1, z1 ), (x2, y2, z2')):xs
          | b' == b && x1' == x1 && x2' == x2 && z1' == z1 && z2' == z2 && y2' + 1 == y1  =
            combine $ (b, (x1, y1', z1), (x2, y2, z2 )):xs
          | b' == b && x1' == x1 && x2' == x2 && z1' == z1 && z2' == z2 && y2  + 1 == y1' =
            combine $ (b, (x1, y1,  z1), (x2, y2', z2)):xs
          | b' == b && y1' == y1 && y2' == y2 && z1' == z1 && z2' == z2 && x2' + 1 == x1  =
            combine $ (b, (x1', y1, z1), (x2, y2, z2 )):xs
          | b' == b && y1' == y1 && y2' == y2 && z1' == z1 && z2' == z2 && x2  + 1 == x1' =
            combine $ (b, (x1,  y1, z1), (x2', y2, z2)):xs
